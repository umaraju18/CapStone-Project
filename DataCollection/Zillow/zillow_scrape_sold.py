...
# Updated this file to add some additional columns.
...
zl.navigate_to_website(driver, "https://www.zillow.com/homes/recently_sold/house_type/95117")
...
columns = ["latitude", "longitude", "address", "city", "state", "zip", "bedrooms", 
           "bathrooms", "sqft", "lot_size", "year_built", "price/sqft", "sale_type", "date_sold",
           "days_on_zillow",  "url"]
