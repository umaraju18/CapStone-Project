...
def invoke_zillow_sale(zipcode):    
    st = []
    st.append(zipcode)
    ...
    zl.navigate_to_website(driver, "https://www.zillow.com/homes/for_sale/house_type")
    ...
    file_name = "sale_%s_%s_%s.csv" % (zipcode, str(time.strftime("%Y-%m-%d")), 
...
'''
invoke_zillow_sale("95002")
invoke_zillow_sale("95101")
invoke_zillow_sale("95103")
invoke_zillow_sale("95106")
invoke_zillow_sale("95108")
invoke_zillow_sale("95109")
invoke_zillow_sale("95110")
invoke_zillow_sale("95111")
invoke_zillow_sale("95112")
invoke_zillow_sale("95113")
# zip from 15 to 36
for x in range(15,37):
    tail = str(x)
    fullzip = "951" + tail
    invoke_zillow_sale(fullzip)

invoke_zillow_sale("95138")
invoke_zillow_sale("95139")
invoke_zillow_sale("95140")
invoke_zillow_sale("95141")
invoke_zillow_sale("95148")
'''
# for 50 to 61
...
invoke_zillow_sale("95164")
invoke_zillow_sale("95170")
invoke_zillow_sale("95172")
invoke_zillow_sale("95173")
