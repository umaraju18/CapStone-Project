...
def invoke_zillow_sold(zipcode):    
    st = []
    st.append(zipcode)
    ...
    file_name = "sold_%s_%s_%s.csv" % (zipcode, str(time.strftime("%Y-%m-%d")), 
...
invoke_zillow_sold("95002")
invoke_zillow_sold("95101")
invoke_zillow_sold("95103")
invoke_zillow_sold("95106")
invoke_zillow_sold("95108")
invoke_zillow_sold("95109")
invoke_zillow_sold("95110")
invoke_zillow_sold("95111")
invoke_zillow_sold("95112")
invoke_zillow_sold("95113")
# zip from 15 to 36
for x in range(15,37):
    tail = str(x)
    fullzip = "951" + tail
    invoke_zillow_sold(fullzip)

invoke_zillow_sold("95138")
invoke_zillow_sold("95139")
invoke_zillow_sold("95140")
invoke_zillow_sold("95141")
invoke_zillow_sold("95148")
...
invoke_zillow_sold("95164")

invoke_zillow_sold("95170")
invoke_zillow_sold("95172")
invoke_zillow_sold("95173")
