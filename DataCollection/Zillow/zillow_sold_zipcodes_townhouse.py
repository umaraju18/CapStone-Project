...
def invoke_zillow_sold_townhouse(zipcode):    
    st = []
    st.append(zipcode)
    ...
    #url = "https://www.zillow.com/homes/recently_sold/house_type/" + zipcode
    url = "https://www.zillow.com/homes/recently_sold/townhouse_type/" + zipcode 
    ...
    file_name = "sold_townhouse_%s_%s_%s.csv" % (zipcode, str(time.strftime("%Y-%m-%d")), 
                            str(time.strftime("%H%M%S")))
    columns = ["latitude", "longitude", "address", "city", "state", "zip", "bedrooms", 
            "bathrooms", "sqft", "lot_size", "year_built", "price/sqft", "sale_type", "zestimate","date_sold",
            "days_on_zillow",  "url"]
...
#invoke_zillow_sold_townhouse("95002")
#invoke_zillow_sold_townhouse("95101")
invoke_zillow_sold_townhouse("95103")
invoke_zillow_sold_townhouse("95106")
invoke_zillow_sold_townhouse("95108")
invoke_zillow_sold_townhouse("95109")
invoke_zillow_sold_townhouse("95110")
invoke_zillow_sold_townhouse("95111")
invoke_zillow_sold_townhouse("95112")
invoke_zillow_sold_townhouse("95113")
# zip from 15 to 36
for x in range(15,37):
    tail = str(x)
    fullzip = "951" + tail
    invoke_zillow_sold_townhouse(fullzip)

invoke_zillow_sold_townhouse("95138")
invoke_zillow_sold_townhouse("95139")
invoke_zillow_sold_townhouse("95140")
invoke_zillow_sold_townhouse("95141")
invoke_zillow_sold_townhouse("95148")
...
invoke_zillow_sold_townhouse("95164")

invoke_zillow_sold_townhouse("95170")
invoke_zillow_sold_townhouse("95172")
invoke_zillow_sold_townhouse("95173")
...
invoke_zillow_sold_townhouse("95196")